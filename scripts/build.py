...
def footer():
 return '<footer class="shell"><span>Small details. Better interfaces.</span><nav aria-label="Footer"><a href="/license/">License</a><a href="/imprint/">Imprint</a><span>© 2026 iconsforfree</span></nav></footer>'
def dialog():
...
for name,title,desc in [('guide','How to use and customize SVG icons','Learn to download, embed and customize original Line 01 icons.'),('license','Free icon usage license','Use the original iconsforfree icons in personal and commercial projects.'),('imprint','Imprint / Impressum','Provider information and contact details for Icons for free, operated by Andreas Dittes in Berlin.')]:
...
public.mkdir()
for path in PUBLIC_FILES | {'styles.css','tokens.css','app.js','CNAME'}:
